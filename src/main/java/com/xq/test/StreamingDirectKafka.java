...
public class StreamingDirectKafka {
    ...
    //创建JavaInputDStream<String>
    /*public static List<JavaInputDStream<String>> createDStreams(
            List<String> topics,
    ...
    //创建Params
    public static Map<String, String> createSparkParams() {
    ...
    //操作偏移量
    public static void reportOffsets(List<JavaInputDStream<String>> dStreams, KafkaConsumer<String, String> consumer) {
